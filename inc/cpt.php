...
function create_tpg_cpt() {
	...
	$args = array(
		...
		'taxonomies'            => array( 'insurance-category', 'post_tag' ),
		'hierarchical'          => true,
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true,
...
function custom_taxonomy() {
	...
	$labels = array(
		'name'                       => _x( 'insurance-categories', 'Taxonomy General Name', 'text_domain' ),
		'singular_name'              => _x( 'insurance-category', 'Taxonomy Singular Name', 'text_domain' ),
		'menu_name'                  => __( 'Insurance Categories', 'text_domain' ),
